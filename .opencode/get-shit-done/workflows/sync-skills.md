...
INSTALL_JS_GLOBAL="D:/Projects/Victorious Memory 2V/.opencode/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node D:/Projects/Victorious Memory 2V/.opencode/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
