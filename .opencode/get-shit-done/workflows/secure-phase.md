...
```
Agent(
  prompt="Read D:/Projects/Victorious Memory 2V/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/Projects/Victorious Memory 2V/.opencode/get-shit-done/templates/SECURITY.md`
