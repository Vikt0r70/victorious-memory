...
```markdown
Read D:/Projects/Victorious Memory 2V/.opencode/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/Projects/Victorious Memory 2V/.opencode/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/Projects/Victorious Memory 2V/.opencode/agents/gsd-ui-checker.md for instructions.
