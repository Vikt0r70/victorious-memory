...
- **Global scope**: `D:/Projects/Victorious Memory 2V/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `D:/Projects/Victorious Memory 2V/.opencode/notes/`)
...
2. Glob `D:/Projects/Victorious Memory 2V/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (D:/Projects/Victorious Memory 2V/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `D:/Projects/Victorious Memory 2V/.opencode/notes/` — works in any directory
