...
<reference>
@D:/Projects/Victorious Memory 2V/.opencode/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `D:/Projects/Victorious Memory 2V/.opencode/get-shit-done/references/user-profiling.md` to load:
