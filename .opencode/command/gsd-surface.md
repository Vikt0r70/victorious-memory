...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `D:/Projects/Victorious Memory 2V/.opencode/.gsd-surface.json`
(sibling to `D:/Projects/Victorious Memory 2V/.opencode/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `D:/Projects/Victorious Memory 2V/.opencode/skills/gsd-*/`.
...
(`~/.config/opencode`), NOT the skills sub-directory (`D:/Projects/Victorious Memory 2V/.opencode/skills`).
...
`D:/Projects/Victorious Memory 2V/.opencode/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `D:/Projects/Victorious Memory 2V/.opencode/.gsd-surface.json`).
...
<execution_context>
Surface state file: `D:/Projects/Victorious Memory 2V/.opencode/.gsd-surface.json`
Install profile marker: `D:/Projects/Victorious Memory 2V/.opencode/.gsd-profile`
Skill dirs: `D:/Projects/Victorious Memory 2V/.opencode/skills/gsd-*/`
Engine module: `D:/Projects/Victorious Memory 2V/.opencode/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `D:/Projects/Victorious Memory 2V/.opencode/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
